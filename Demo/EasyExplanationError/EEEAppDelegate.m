//
//  EEEAppDelegate.m
//  EasyExplanationError
//
//  Created by Håvard Fossli on 07.02.14.
...
NSString * const EEEAppDelegateDomain = @"EEEAppDelegateDomain";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSError *error = [NSError eee_errorWithDomain:EEEAppDelegateDomain
                                             code:0
    ...
    [error eee_throwExceptionWithName:NSInternalInconsistencyException];
